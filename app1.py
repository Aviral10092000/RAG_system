...
st.set_page_config(page_title="AI Image Assistant", page_icon="🤖")
st.title("Welcome I am AI Image Assistant 🤖")
...
SYS_PROMPT = """
              Act as a helpful image assistant and answer questions to the best of your ability.
